...
태그 수정·비활성화·병합·물리 삭제와 자연어 검색의 동적 사전 전환은 후속 이슈다. 상세 화면 동작은 [태그 정의 API](../../../05-specs/api/admin/tag-definition-api.md)와 [구현 계획](../../../08-planning/admin-tag-definition-creation.md)을 따른다.
