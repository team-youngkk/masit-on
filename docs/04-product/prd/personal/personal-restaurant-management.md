...
5. 시스템은 최근 기록 upsert에서 회원별 최신 50개만 유지하고, 회원 조회와 독립된 주기 cleanup Command로 마지막 조회 후 30일이 지난 기록을 정리한다.
...
- 최근 기록 upsert의 최신 50개 상한과 주기 cleanup Command의 마지막 조회 후 30일 보존
...
- 최근 본 맛집은 재조회 시 맨 앞으로 이동하고 중복 표시되지 않으며 upsert의 최신 50개 상한과 주기 cleanup Command의 30일 규칙을 지킨다.
...
- 최근 기록의 정상 상세 조회 생성, 재조회 갱신, 실패 조회 미생성, 최신 50개 상한과 주기 cleanup Command의 30일 만료가 검증된다.
