...
| 페이지네이션 | 맛집 탐색은 크기 10·20·21·50, 기본 21, 범위 밖은 빈 목록. 그 외 목록은 공통 기본값 20 | 페이지 입력과 메타데이터 계약 | [WS-01](mvp-workstreams.md#5-ws-01-맛집-탐색), [WS-03](mvp-workstreams.md#7-ws-03-유튜버-기반-탐색) |
...
- 검색과 필터의 AND 조합
- 페이지 크기 10·20·21·50, 기본 21과 페이지 이동
...
| 로컬 통합 실행·헬스체크 | 로컬 통합 성공과 저장소·외부 장애 구분 | 전체 인수 전 | 최소 기준은 예 | 필요 | 전체 | Docker 통합 실행과 상태 확인 통과 |
