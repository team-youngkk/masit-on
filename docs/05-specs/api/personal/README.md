...
[WS-09](../../../02-analysis/second-expansion-workstreams.md#4-ws-09-개인-컬렉션)은 [개인 컬렉션 API](personal-collection-api.md)에서 회원별 비공개 컬렉션과 맛집 포함 관계를 소유한다. 컬렉션은 찜 폴더가 아니며 찜·최근 기록과 독립된 자원이다.
