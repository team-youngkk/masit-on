...
| [WS-15](../02-analysis/third-expansion-workstreams.md#6-ws-15-ai-영상-정보-추출) | API-ADMIN-AIEXTRACT-001·API-ADMIN-AIEXTRACT-WEBHOOK-001~002 | 비동기 Job·후보 Snapshot·자동 등록·예외 보정·채널 감시 GET/PUT 상태 소유 |
