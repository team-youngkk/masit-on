...
| `./gradlew.bat test --tests ...KakaoMobilityCourseRouteAdapterWireMockIntegrationTest --tests ...RedisCourseRouteQuotaIntegrationTest --tests ...RestaurantCourseRouteApiTest --tests com.masiton.deploy.AppRunScriptContractTest --no-daemon --max-workers=1` | 통과 | 새 리뷰 반영 후 Adapter 21건, Redis quota 5건, API 19건, app-run 계약 1건을 확인했다. |
