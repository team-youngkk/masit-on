...
- `WS-01`~`WS-16`의 16개 제품 Workstream과 MVP 20개·1차 확장 21개·2차 확장 21개·3차 확장 9개, 총 71개 기능 요구사항에 각각 최종 책임자 한 명이 지정되어 있다. `OPS-*`와 `QUALITY-EVAL`은 제품 Workstream 수와 별도로 관리한다.
