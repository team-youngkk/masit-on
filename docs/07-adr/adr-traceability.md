...
| [OPS-VALIDATION](../02-analysis/first-expansion-workstreams.md#ops-validation-공통-운영배포-트랙) | [ADR-DEPLOY-004](platform/deploy-004-public-api-validation-gate-boundary.md), [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-WEB-005](platform/web-005-application-port-binding.md), [ADR-SEC-001](security/sec-001-secrets-workload-identity.md), [ADR-DEPLOY-002](platform/deploy-002-validation-deployment-before-expansion.md) | 검증 참여자 쿠키·Redis·Nginx 진입 경계, 공개 API gate 예외, loopback 애플리케이션 포트, 정식 공개 시 전체 제거 |
