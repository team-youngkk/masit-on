...
| Redis 8.8 전용 인스턴스 | 통합 인증 Refresh session 역할과 배포 고도화 운영 배치 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-DATA-005](data/data-005-redis-refresh-token.md), [ADR-DEPLOY-005](platform/deploy-005-asg-blue-green-rollout.md) | 회원·관리자 Refresh session을 사설 subnet 전용 Redis에 저장하며 캐시·락은 별도 조건부. 검증 참여자 `auth:verification:*`는 정식 공개 전환으로 제거 |
...
| Redis 통합 Refresh session | 팀 합의 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md) | MEMBER 최대 3세션·ADMIN 최대 1세션, 원자 회전·재사용 탐지 |
...
| 통합 Spring Security 7.1.0 + JWT RBAC | 팀 합의 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md) | 단일 계정 인증과 `/api/admin/**` ADMIN 인가 기준 |
| 통합 Refresh Token 보안 쿠키 | 팀 합의 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-AUTH-006](security/auth-006-cookie-origin-defense.md) | Redis 저장·회전, HttpOnly·Secure·Origin 방어 |
| 회원·관리자 Refresh·Logout Origin 검증 | 구현 범위 확정 | Accepted ADR | [ADR-AUTH-006](security/auth-006-cookie-origin-defense.md) | 단일 Origin 헤더와 경계별 canonical allowlist |
...
| 회원·관리자 통합 JWT·Refresh Token | 팀 합의 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-AUTH-006](security/auth-006-cookie-origin-defense.md) | 단일 audience·쿠키·namespace, 역할별 세션 상한, Refresh·Logout Origin 방어 |
...
| Nginx | 경로 경계 결정 갱신 (2026-08-18) | Accepted ADR | [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-RUNTIME-001](platform/runtime-001-docker.md) | `/api/**`는 Spring Boot, 나머지 외부 경로는 Next.js, `/internal/**`은 외부 차단. 애플리케이션 포트 바인딩은 [ADR-WEB-005](platform/web-005-application-port-binding.md)가 별도로 소유한다 |
...
| API 영역 | 관련 ADR | 경계 |
|---|---|---|
| 공개 탐색·상세 API | [ADR-WEB-002](platform/web-002-data-state.md), [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-ARCH-001](architecture/arch-001-domain-monolith.md), [ADR-ARCH-003](adr-backlog.md#adr-arch-003-조회-확장-패턴), [ADR-DATA-003](data/data-003-spring-data-jpa.md) | `/api` 경로와 계약은 `docs/05-specs/api/`가 소유 |
| 통합 계정·인증 API | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-AUTH-006](security/auth-006-cookie-origin-defense.md), [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md) | 단일 token matcher, JWT RBAC, Redis session 보안 쿠키와 Origin 방어 |
...
| 정식 공개 전환 | [ADR-DEPLOY-006](platform/deploy-006-public-release-without-validation-gate.md), [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-WEB-005](platform/web-005-application-port-binding.md) | 검증 참여자 쿠키·Redis·Nginx gate 없이 공개하며 제품 API 인증은 유지. Webhook 자체 인증·rate limit, Host, `/internal` 외부 404와 loopback 경계를 보존 |
| 검증 참여자 세션 API (역사) | [ADR-DEPLOY-003](platform/deploy-003-validation-cookie-session.md), [ADR-DEPLOY-004](platform/deploy-004-public-api-validation-gate-boundary.md), [ADR-DEPLOY-006](platform/deploy-006-public-release-without-validation-gate.md) | M2의 쿠키·Redis·Nginx 진입 경계 기록이며 현재 API 계약이 아님. 정식 공개 전환으로 제거 |
| 전체 API | [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-TEST-001](quality/test-001-automation-strategy.md), [ADR-OBS-001](quality/obs-001-logging-observability.md) | `/api` 전달, 계약·장애 테스트와 요청 추적 |
...
| 사용자·토큰·기기 데이터 | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-NOTIFY-002](integration/notify-002-in-app-notification-reliability.md), [ADR-NOTIFY-001](adr-backlog.md#adr-notify-001-fcm-푸시-알림) | 통합 계정·session과 서비스 내 Notification만 저장; Preference·DeviceToken은 Post-MVP |
...
| [WS-04](../02-analysis/mvp-workstreams.md#8-ws-04-관리자-데이터-등록) | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md), [ADR-AUTH-003](security/auth-003-confirmation-token.md), [ADR-AUTH-006](security/auth-006-cookie-origin-defense.md), [ADR-WEB-006](platform/web-006-unified-login-rbac-route.md), [ADR-EXT-001](integration/ext-001-reference-verification.md), [ADR-EXT-002](adr-backlog.md#adr-ext-002-자동-복원력과-신뢰성-이벤트-전달), [ADR-ARCH-002](architecture/arch-002-external-ports-adapters.md), [ADR-DATA-003](data/data-003-spring-data-jpa.md)~[ADR-DATA-004](data/data-004-flyway.md), [ADR-DATA-006](adr-backlog.md#adr-data-006-동시-쓰기-충돌-제어), [ADR-SEC-001](security/sec-001-secrets-workload-identity.md) | 통합 로그인·관리자 화면·API 경로, RBAC·Origin 방어·확인 Token·외부 확인·등록 정합성 |
| [OPS-VALIDATION](../02-analysis/first-expansion-workstreams.md#ops-validation-공통-운영배포-트랙) | [ADR-DEPLOY-002](platform/deploy-002-validation-deployment-before-expansion.md), [ADR-DEPLOY-006](platform/deploy-006-public-release-without-validation-gate.md), [ADR-WEB-005](platform/web-005-application-port-binding.md), [ADR-SEC-001](security/sec-001-secrets-workload-identity.md) | M2 제한 공개·검증은 완료된 역사 트랙. 현재 책임은 gate 제거 확인과 회원·관리자 인증, Webhook·Host·`/internal`·loopback 운영 경계 회귀 |
...
| [QUALITY-EVAL](../02-analysis/third-expansion-workstreams.md#8-quality-eval-교차-품질-트랙) | [ADR-TEST-001](quality/test-001-automation-strategy.md), [ADR-PERF-001](quality/perf-001-k6-load-testing.md), [ADR-PERF-002](quality/perf-002-operational-participant-load-testing.md), 3차 Accepted ADR 전체 | 골든 Dataset·Evaluator·2차 부하 승계·출시 게이트와 #190 운영 직접 증거 |
...
| Redis 역할 선확정 | [ADR-CACHE-001](adr-backlog.md#adr-cache-001-redis-캐시-도입), [ADR-LOCK-001](adr-backlog.md#adr-lock-001-redis-분산-락-도입), [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md) |
...
| [ADR-EXT-004](integration/ext-004-youtube-periodic-reconciliation.md) | FR-AIEXTRACT-004·NFR-COST-001의 활성 Watch 자동 보정·필수 운영 주기·중지·quota | `YoutubeChannelBackfillServiceTest`, `JdbcYoutubeChannelBackfillRunStoreIntegrationTest`, `YoutubeChannelBackfillPropertiesTest`, 파일 배포 fixture | 이슈 #375 / PR #385 |
