...
| Redis 8.8 전용 인스턴스 | 통합 인증 session 역할 확정 | Accepted ADR | [ADR-AUTH-007](security/auth-007-unified-account-rbac-session.md) | 회원·관리자 통합 Refresh session 저장, 캐시·락은 별도 조건부 |
