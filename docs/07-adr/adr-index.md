...
| [ADR-DEPLOY-007](platform/deploy-007-codedeploy-health-alarm-boundary.md) | CodeDeploy 전환 중 ALB 호스트 상태 알람과 배포 게이트 분리 | Superseded | Critical | ALB, CodeDeploy, CloudWatch | 2026-09-03 CloudWatch 관측·배포 alarm 경로 폐기. ASG 재개 시 별도 ADR 필요 | [문서](platform/deploy-007-codedeploy-health-alarm-boundary.md) |
