...
| [ADR-DEPLOY-005](platform/deploy-005-asg-blue-green-rollout.md) | ASG 기반 Blue-Green 운영 배포 | Proposed | Critical | ALB, ASG, CodeDeploy, Redis, GitHub Actions | 배포 고도화 구현 제안; 운영 전환은 별도 승인 | [문서](platform/deploy-005-asg-blue-green-rollout.md) |
