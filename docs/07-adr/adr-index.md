...
| [ADR-AI-001](integration/ai-001-video-extraction-candidate-boundary.md) | AI 영상 추출 후보 경계와 제공자 선택 기준 | Accepted | Critical | Gemini Free Tier 전용, `gemini-3-flash-preview`, P1/S1 | [WS-15](../02-analysis/third-expansion-workstreams.md#6-ws-15-ai-영상-정보-추출) | [문서](integration/ai-001-video-extraction-candidate-boundary.md) |
