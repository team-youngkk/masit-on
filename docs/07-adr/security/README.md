...
| ADR | 제목 |
|---|---|
| [ADR-AUTH-001](auth-001-spring-security-jwt.md) | 관리자 Spring Security JWT 인증·인가(Superseded) |
| [ADR-AUTH-002](auth-002-member-jwt-refresh-token.md) | 회원 JWT와 Refresh Token(Superseded) |
...
| [ADR-AUTH-007](auth-007-unified-account-rbac-session.md) | 통합 계정 RBAC와 세션 |
