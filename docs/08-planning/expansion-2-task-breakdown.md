...
| `E2-T14` | 알림 화면을 연결하고 지원 브라우저·360px·키보드 접근성을 포함한 전체 사용자 여정과 E2E 자동화를 완료한다 | 전원 / 상호 교차 리뷰 | `E2-T13` | 불가 | `TST-E2-E2E-001`; 탐색·개인화·참여·알림 브라우저 여정 검증 |
...
- `E2-T14`는 서비스 내 알림 화면을 연결하고, 지원 브라우저·360px·키보드 접근성을 포함한 전체 사용자 여정과 `TST-E2-E2E-001`을 완료한다(이슈 #144). E2E 자동화 도구 도입은 3차 확장에서 별도 ADR로 결정하며, 도입 전까지는 수동 검증으로 대체한다.
