...
| `E3-T04` | AI 작업 접수·Webhook·Gemini Provider·버전 경계를 구현한다 | 김인안 / 이우람 | `E3-T03` | 가능 | `TST-E3-AI-001`; `202`, 멱등 Job, Webhook AI 호출 격리, 현재 Prompt P6·Schema S1·기존 P1·P2·P3·P4·P5 이력 보존·Free Tier 차단 |
