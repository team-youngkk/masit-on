...
- 페이지는 1부터 시작한다. 일반 목록은 크기 10·20·50, 기본값 20을 사용하고, 맛집 탐색은 기존 호출 호환을 위해 크기 10·20·21·50, 기본값 21을 사용한다.
...
| WS1-02 안정 정렬과 페이지를 구현한다 | 1-base 페이지, 일반 목록 크기 10·20·50·기본 20, 맛집 탐색 크기 10·20·21·50·기본 21, 안정 정렬 | 첫·마지막·범위 밖 페이지, 중복·누락 | 페이지 이동 중 항목 중복·누락 0건 |
